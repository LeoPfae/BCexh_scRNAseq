...
in.path = "../../data/E-MTAB-10607/"
out.path = "../../data/doublet_output/"
TBB075.data <- read.table("../../data/E-MTAB-10607/TBB075_singlecell_count_matrix.txt")
TBB075.data <- as(as.matrix(TBB075.data), "sparseMatrix")
```
...
TBB075.singlet <- subset(x = TBB075, idents =c("Singlet"))
...
#Save Seurat object
saveRDS(TBB075.singlet, file = paste0("../../data/doublet_output/", "TBB075_singlet.rds"))
```