...
TBB111.data <- read.table("../../data/E-MTAB-10607/TBB111_singlecell_count_matrix.txt")
TBB111.data <- as(as.matrix(TBB111.data), "sparseMatrix")
```
...
TBB111.singlet <- subset(x = TBB111, idents =c("Singlet"))
...
#Save Seurat object
saveRDS(TBB111.singlet, file = paste0("../../data/doublet_output/", "TBB111_singlet.rds"))
```