...
TBB129.data <- read.table("../../data/E-MTAB-10607/TBB129_singlecell_count_matrix.txt")
TBB129.data <- as(as.matrix(TBB129.data), "sparseMatrix")
```
...
TBB129.singlet <- subset(x = TBB129, idents = c("Singlet"))
...
#Save Seurat object
saveRDS(TBB129.singlet, file = paste0("../../data/doublet_output/", "TBB129_singlet.rds"))
```