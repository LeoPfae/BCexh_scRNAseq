...
TBB165.data <- read.table("../../data/E-MTAB-10607/TBB165_singlecell_count_matrix.txt")
TBB165.data <- as(as.matrix(TBB165.data), "sparseMatrix")
```
...
TBB165.singlet <- subset(x = TBB165, idents = c("Singlet"))
...
#Save Seurat object
saveRDS(TBB165.singlet, file = paste0("../../data/doublet_output/", "TBB165_singlet.rds"))
```