...
TBB171.data <- read.table("../../data/E-MTAB-10607/TBB171_singlecell_count_matrix.txt")
TBB171.data <- as(as.matrix(TBB171.data), "sparseMatrix")
```
...
## Plot results 
```{r}
TBB171@meta.data[,"DF_hi.lo"] <- TBB171@meta.data$DF.classifications_0.25_0.005_700
...
TBB171.singlet <- subset(x = TBB171, idents = c("Singlet"))
...
#Save Seurat object
saveRDS(TBB171.singlet, file = paste0("../../data/doublet_output/", "TBB171_singlet.rds"))
```