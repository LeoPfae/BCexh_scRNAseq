...
TBB214.data <- read.table("../../data/E-MTAB-10607/TBB214_singlecell_count_matrix.txt")
TBB214.data <- as(as.matrix(TBB214.data), "sparseMatrix")
```
...
TBB214.singlet <- subset(x = TBB214, idents = c("Singlet"))

#Test
DimPlot(object = TBB214.singlet, reduction = 'tsne', pt.size = 0.5)

#Save Seurat object
saveRDS(TBB214.singlet, file = paste0("../../data/doublet_output/", "TBB214_singlet.rds"))
```