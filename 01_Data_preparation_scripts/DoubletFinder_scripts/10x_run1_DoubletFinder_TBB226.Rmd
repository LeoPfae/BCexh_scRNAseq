...
TBB226.data <- read.table("../../data/E-MTAB-10607/TBB226_singlecell_count_matrix.txt")
TBB226.data <- as(as.matrix(TBB226.data), "sparseMatrix")
```
...
TBB226.singlet <- subset(x = TBB226, idents = c("Singlet"))

#Test
DimPlot(object = TBB226.singlet, reduction = 'tsne', pt.size = 0.5)

#Save Seurat object
saveRDS(TBB226.singlet, file = paste0("../../data/doublet_output/", "TBB226_singlet.rds"))
```