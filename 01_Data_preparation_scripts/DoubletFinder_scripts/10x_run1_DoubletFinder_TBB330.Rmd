...
TBB330.data <- read.table("../../data/E-MTAB-10607/TBB330_singlecell_count_matrix.txt")
TBB330.data <- as(as.matrix(TBB330.data), "sparseMatrix")
```
...
TBB330.singlet <- subset(x = TBB330, idents = c("Singlet"))
...
#Save Seurat object
saveRDS(TBB330.singlet, file = paste0("../../data/doublet_output/", "TBB330_singlet.rds"))
```