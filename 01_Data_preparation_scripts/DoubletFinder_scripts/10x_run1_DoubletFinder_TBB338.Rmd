...
TBB338.data <- read.table("../../data/E-MTAB-10607/TBB338_singlecell_count_matrix.txt")
TBB338.data <- as(as.matrix(TBB338.data), "sparseMatrix")
```
...
TBB338.singlet <- subset(x = TBB338, idents = c("Singlet"))

#Test
DimPlot(object = TBB338.singlet, reduction = 'tsne', pt.size = 0.5)

#Save Seurat object
saveRDS(TBB338.singlet, file = paste0("../../data/doublet_output/", "TBB338_singlet.rds"))
```