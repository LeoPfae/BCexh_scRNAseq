...
TBB011.data <- read.table("../../data/E-MTAB-10607/TBB011_singlecell_count_matrix.txt")
TBB011.data <- as(as.matrix(TBB011.data), "sparseMatrix")
```
...
TBB011.singlet <- subset(x = TBB011, idents =c("Singlet"))
...
#Save Seurat object
saveRDS(TBB011.singlet, file = paste0("../../data/doublet_output/", "TBB011_singlet.rds"))
```