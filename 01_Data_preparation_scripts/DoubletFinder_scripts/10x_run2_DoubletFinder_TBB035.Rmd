...
TBB035.data <- read.table("../../data/E-MTAB-10607/TBB011_singlecell_count_matrix.txt")
TBB035.data <- as(as.matrix(TBB035.data), "sparseMatrix")
```
...
TBB035 <- doubletFinder_v3(TBB035, PCs = 1:10, pN = 0.25, pK = 0.005, nExp = nExp_poi.adj, reuse.pANN = "pANN_0.25_0.005_1000")
```

## Plot results 
```{r}
TBB035@meta.data[,"DF_hi.lo"] <- TBB035@meta.data$DF.classifications_0.25_0.005_1000
...
#Save Seurat object
saveRDS(TBB035.singlet, file = paste0("../../data/doublet_output/", "TBB035_singlet.rds"))
