...
TBB184.data <- read.table("../../data/E-MTAB-10607/TBB184_singlecell_count_matrix.txt")
TBB184.data <- as(as.matrix(TBB184.data), "sparseMatrix")
```
...
TBB184.singlet <- subset(x = TBB184, idents =c("Singlet"))
...
#Save Seurat object
saveRDS(TBB184.singlet, file = paste0("../../data/doublet_output/", "TBB184_singlet.rds"))
```