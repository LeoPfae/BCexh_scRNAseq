...
TBB212.data <- read.table("../../data/E-MTAB-10607/TBB212_singlecell_count_matrix.txt")
TBB212.data <- as(as.matrix(TBB212.data), "sparseMatrix")
```
...
TBB212.singlet <- subset(x = TBB212, idents =c("Singlet"))
...
#Save Seurat object
saveRDS(TBB212.singlet, file = paste0("../../data/doublet_output/", "TBB212_singlet.rds"))
```